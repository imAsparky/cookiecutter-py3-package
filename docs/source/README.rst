...
.. .. image:: https://travis-ci.org/audreyfeldroy/cookiecutter-py3-package.svg?branch=master
..     :target: https://travis-ci.org/github/audreyfeldroy/cookiecutter-py3-package
..     :alt: Build Status

.. image:: https://readthedocs.org/projects/cookiecutter-py3-package/badge/?version=v0.1.1
    :target: https://cookiecutter-py3-package.readthedocs.io/en/v0.1.1/?badge=v0.1.1
    :alt: Documentation Status


**A fork of the** Cookiecutter-Pypackage_
...
.. image:: https://img.shields.io/travis/audreyfeldroy/cookiecutter-py3-package.svg
    :target: https://travis-ci.org/audreyfeldroy/cookiecutter-py3-package
    :alt: Linux build status on Travis CI

Windows:

.. image:: https://ci.appveyor.com/api/projects/status/github/audreyr/cookiecutter-py3-package?branch=master&svg=true
    :target: https://ci.appveyor.com/project/audreyr/cookiecutter-py3-package/branch/master
...
For more details, see the `cookiecutter-py3-package tutorial`_.

.. _`cookiecutter-py3-package tutorial`: https://cookiecutter-py3-package.readthedocs.io/en/latest/tutorial.html
