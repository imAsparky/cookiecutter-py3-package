...
.. _bug: https://github.com/imAsparky/cookiecutter-py3-package/issues

Fix Bugs
~~~~~~~~

Look through Cookiecutter Py3 Package GitHub issues_ for bugs.
...
Look through Cookiecutter Py3 Package GitHub issues_ for features.
...
Cookiecutter Py3 Package strives to have excellent documentation for
several reasons:
...
Cookiecutter Py3 Package provides the four pillars Tutorials, How-to, Reference and
...
Cookiecutter Py3 Package uses Sphinx to document the API.  Class's, modules, or
...
an `Issue <https://github.com/imAsparky/cookiecutter-py3-package/issues>`_.
...
Here's how to set up `cookiecutter-py3-package` for local development. We have
...
2. From your GitHub account, fork the `cookiecutter-py3-package` repository.
...
.. code-block:: bash
    ...
    git clone git@github.com:your_git_user_name_here/cookiecutter-py3-package.git

    cd cookiecutter-py3-package
...
.. note::
    ...
    Cookiecutter Py3 Package uses python-semantic-release.

    For semantic version to work, commit messages must follow
    `Conventional Commits <https://www.conventionalcommits.org/en/v1.0.0/>`_.

    See an example of how they look
    `here <https://github.com/imAsparky/cookiecutter-py3-package>`_.
...
.. _issues: https://github.com/imAsparky/cookiecutter-py3-package/issues
